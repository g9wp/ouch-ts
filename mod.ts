...
//
// This is the runtime-agnostic core (the default entry). File helpers are
// runtime-specific and live in ./deno.ts and ./node.ts — import
// "@g9wp/ouch/deno" or "@g9wp/ouch/node" (or re-export from them) to get
// `fromFile`/`fileSink`/`readFile`/`writeFile`/`loadFile`.
